...
class UNet(nn.Module):
    def __init__(self, input_channels=3, num_classes, **kwargs):
        super().__init__()
        ...
        self.conv2_2 = Down(nb_filter[2]+nb_filter[3], nb_filter[2], nb_filter[2])
        self.conv1_3 = Down(nb_filter[1]+nb_filter[2], nb_filter[1], nb_filter[1])
        self.conv0_4 = Down(nb_filter[0]+nb_filter[1], nb_filter[0], nb_filter[0])
...
class UPPNet(nn.Module):
    def __init__(self, input_channels=3, num_classes, deep_supervision=False, **kwargs):
        super().__init__()
        ...
        self.conv0_4 = Down(nb_filter[0]*4+nb_filter[1], nb_filter[0], nb_filter[0])
